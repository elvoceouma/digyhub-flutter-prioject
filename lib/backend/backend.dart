...
import 'schema/new_receipt_record.dart';
...
export 'schema/new_receipt_record.dart';
...
/// Functions to query NewReceiptRecords (as a Stream and as a Future).
Future<int> queryNewReceiptRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      NewReceiptRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<NewReceiptRecord>> queryNewReceiptRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      NewReceiptRecord.collection,
      NewReceiptRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<NewReceiptRecord>> queryNewReceiptRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
