...
final kTranslationsMap = <Map<String, Map<String, String>>>[
  ...
  // completeProfile
  {
    ...
    'r6npjsue': {
      'en': 'Upload your business logo to be used  in receipts header',
    ...
    'sqcv33ar': {
      'en': 'Retail and Shopping',
      'ar': '',
      'de': '',
      'es': '',
    },
    'hijgmyxb': {
      'en': 'Hospitality and Accommodation',
      'ar': '',
      'de': '',
      'es': '',
    },
    'zm3gikpz': {
      'en': 'Beauty and Fashion',
      'ar': '',
      'de': '',
      'es': '',
    },
    'c5i8xnpy': {
      'en': 'Entertainment and Recreation',
      'ar': '',
      'de': '',
      'es': '',
    },
    '50g41npu': {
      'en': 'Online and Ecommerce',
      'ar': '',
      'de': '',
      'es': '',
    },
    '00243pf0': {
      'en': 'Heathcare and Medical',
      'ar': '',
      'de': '',
      'es': '',
    },
    ...
    'pf8glhkg': {
      'en': 'What is the business location?',
      'ar': 'ماهوموقعك؟',
  ...
  // onboarding
  {
    ...
    'hxtwax0y': {
      'en':
          'Diggy receipts provide a faster and paperless way of  sharing receipts with customers',
      'ar':
    ...
    'uf9k1spp': {
      'en':
          'Easily add transactions and associate them with sales that have been created.',
    ...
    'q30ina4f': {
      'en': 'Know where your business is and how it can be adjusted.',
  ...
  // transferComplete
  {
    ...
    'iq9jjji8': {
      'en':
          'Great work, you successfully sent the receipt. It may take a few seconds for the receipt to reac the client',
      'ar':
  ...
  // tutorial_PROFILE
  {
    ...
    't6k1smsm': {
      'en':
          'Easily add transactions and associate them with sales that have made.',
      'ar': 'أضف المعاملات بسهولة وربطها بالميزانيات التي تم إنشاؤها.',
      'de':
          'Fügen Sie ganz einfach Transaktionen hinzu und verknüpfen Sie sie mit erstellten Budgets.',
      'es':
  ...
  // budget_DELETE
  {
    ...
    'u0kr38at': {
      'en': 'Tap above to remove this receipt',
  ...
  // Miscellaneous
  {
    ...
    'ixziz9kj': {
      'en': 'In order to import customers contact',
      'ar': '',
      'de': '',
      'es': '',
    },
    'efk25pk0': {
      'en': 'In ordeer to send you updates',
      'ar': '',
      'de': '',
      'es': '',
    },
